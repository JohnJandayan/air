...
def mvpcss(*children: object, is_htmx: bool = False, **kwargs: AttributesType) -> Html | Children:
...
def picocss(*children: object, is_htmx: bool = False, **kwargs: AttributesType) -> Html | Children:
